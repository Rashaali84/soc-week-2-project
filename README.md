...
## General info
The Motivation behind this project is to get more comfortable with java-scripts basics , dealing with different types and using differnet operators and etc..
...
## Features
The project is divided into many steps as user-stories is mapped to branchs as follows :
